...
public final class PairedIterableTest {
    ...
    private static final List<String> SMALL_STRINGS_LIST = unmodifiableList(stringsList(SMALL_LIST_SIZE));
    private static final List<String> LARGE_STRINGS_LIST = unmodifiableList(stringsList(LARGE_LIST_SIZE));
