...
public class StandardBloomFilterTest {
    ...
    public void constructorTest() {
        ...
        AbstractBloomFilter bf = new StandardBloomFilter(pbf, fc);
    ...
    public void getLogTest_NoValues() {
        ...
        AbstractBloomFilter bf = new StandardBloomFilter(bs);
    ...
    public void equalityTest() {
        BitSet bs = new BitSet();
        bs.set(2);
        AbstractBloomFilter bf1 = new StandardBloomFilter(bs);
        StandardBloomFilter bf2 = new StandardBloomFilter(bs);
    ...
    public void inverseMatchTest() {
        ...
        bs.set(40);
        AbstractBloomFilter bf2 = new StandardBloomFilter(bs);
