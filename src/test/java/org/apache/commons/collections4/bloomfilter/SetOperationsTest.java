...
public class SetOperationsTest {
    ...
    public void testDifferentShapesThrows() {
        ...
        final Hasher hasher = new SimpleHasher(lst.iterator(), shape);
        ...
        final Hasher hasher2 = new SimpleHasher(lst2.iterator(), shape2);
    ...
    public final void cosineDistanceTest() {
        ...
        Hasher hasher = new SimpleHasher(lst.iterator(), shape);
        BloomFilter filter1 = new HasherBloomFilter(hasher, shape);

        List<Integer> lst2 = Arrays.asList(2, 3);
        Hasher hasher2 = new SimpleHasher(lst2.iterator(), shape);
    ...
    public final void estimateIntersectionSizeTest() {
        ...
        final Hasher hasher2 = new SimpleHasher(lst.iterator(), shape);
