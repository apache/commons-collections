...
public class MapUtilsTest {
    ...
    public void testgetDoubleValue() {
        ...
        assertEquals(2, MapUtils.getDoubleValue(in,"key", 0.0), 0);
        assertEquals(2, MapUtils.getDoubleValue(in,"key"), 0);
        assertEquals(1, MapUtils.getDoubleValue(in,"noKey", 1.0), 0);
        assertEquals(0, MapUtils.getDoubleValue(in,"noKey"), 0);
        assertEquals(2, MapUtils.getDouble(in,"key", 0.0), 0);
        assertEquals(1, MapUtils.getDouble(in,"noKey", 1.0), 0);

        
        final Map<String, String> inStr = new HashMap<>();
        inStr.put("str1", "2");
        
        assertEquals(2, MapUtils.getDoubleValue(inStr,"str1", 0.0), 0);
    }
    ...
    public void testgetFloatValue() {
        ...
        assertEquals(2, MapUtils.getFloatValue(in,"key", 0), 0);
        assertEquals(2, MapUtils.getFloatValue(in,"key"), 0);
        assertEquals(1, MapUtils.getFloatValue(in,"noKey", 1.0f), 0);
        assertEquals(0, MapUtils.getFloatValue(in,"noKey"), 0);
        assertEquals(2, MapUtils.getFloat(in,"key", 0.0f), 0);
        assertEquals(1, MapUtils.getFloat(in,"noKey", 1.0f), 0);
        
        final Map<String, String> inStr = new HashMap<>();
        inStr.put("str1", "2");
        
        assertEquals(2, MapUtils.getFloatValue(inStr,"str1", 0.0f), 0);
    }
    ...
    public void testgetLongValue() {
        ...
        assertEquals(2, MapUtils.getLongValue(in,"key", 0L), 0);
        assertEquals(2, MapUtils.getLongValue(in,"key"), 0);
        assertEquals(1, MapUtils.getLongValue(in,"noKey", 1L), 0);
        assertEquals(0, MapUtils.getLongValue(in,"noKey"), 0);
        assertEquals(2, MapUtils.getLong(in,"key", 0L), 0);
        assertEquals(1, MapUtils.getLong(in,"noKey", 1L), 0);
        
        final Map<String, String> inStr = new HashMap<>();
        inStr.put("str1", "2");
  
        assertEquals(2, MapUtils.getLongValue(inStr,"str1", 0L), 0);
        assertEquals(2, MapUtils.getLong(inStr, "str1", 1L), 0);
    ...
    public void testgetIntValue() {
        ...
        assertEquals(2, MapUtils.getIntValue(inStr,"str1", 0), 0);
    }
    ...
    public void testgetString() {
        ...
        assertEquals("str", MapUtils.getString(in,"key"), "str");
