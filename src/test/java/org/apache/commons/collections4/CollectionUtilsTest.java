...
//Up to here
    ...
    public void testAsString() {
        String result = CollectionUtils.asString(collectionA, new Transformer<Integer, String>() {
        ...
        result = CollectionUtils.asString(new ArrayList<Integer>(), new Transformer<Integer, String>() {
            public String transform(Integer input) {
    ...
    @Test
    public void testAsStringWithDelimiter() {
        String result = CollectionUtils.asString(collectionA, new Transformer<Integer, String>() {
            public String transform(Integer input) {
                return new Integer(input * 2).toString();
            }
    ...
    @Test
    public void testAsStringWithNullIterable() {
        try{
            CollectionUtils.asString(null, new Transformer<Integer, String>() {
                public String transform(Integer input) {
                    fail("not supposed to reach here");
                    return "";
                }
    ...
    @Test
    public void testAsStringWithNullTransformer() {
        try{
            CollectionUtils.asString(new ArrayList<Integer>(), null);
            fail("expecting IllegalArgumentException");
        } catch (final IllegalArgumentException npe) {
        } // this is what we want
    }
    ...
    @Test
    public void testAsStringWithNullDelimiter() {
        try{
            CollectionUtils.asString(new ArrayList<Integer>(), new Transformer<Integer, String>() {
                public String transform(Integer input) {
                    fail("not supposed to reach here");
                    return "";
                }
