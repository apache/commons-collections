 ...
 * @since 3.1
 */
public class IndexedTreeListTest<E> extends AbstractListTest<E> {
...
//    }
    ...
    //-----------------------------------------------------------------------
    @Override
    public IndexedTreeList<E> makeObject() {
...
//    }
    ...
    public void testBug35258() {
        ...
        final List<Integer> IndexedTreeList = new IndexedTreeList<>();
        ...
        final ListIterator<Integer> li = IndexedTreeList.listIterator();
    ...
    public void testBugCollections447() {
        final List<String> IndexedTreeList = new IndexedTreeList<>();
        IndexedTreeList.add("A");
        IndexedTreeList.add("B");
        IndexedTreeList.add("C");
        IndexedTreeList.add("D");

        final ListIterator<String> li = IndexedTreeList.listIterator();
    ...
    public void testIterationOrder() {
        ...
        for (int size = 1; size < 1000; size++) {
            ...
            final IndexedTreeList<Integer> l = new IndexedTreeList<>(other);
    ...
    public void testIterationOrderAfterAddAll() {
        ...
        for (int i = 0; i < 100; i++) {
            ...
            final IndexedTreeList<Integer> l = new IndexedTreeList<>();
            for (int j = 0; j < i; j++) {
                l.add(j);
            }
