 ...
 * <p>
 * Suppose you have a MultiSet that contains {@code {a, a, b, c}}. Calling {@link #getCount(Object)} on {@code a} would return 2, while calling
...
public interface MultiSet<E> extends Collection<E> {
     ...
     * <p>
     * The {@link MultiSet#entrySet()} method returns a view of the multiset whose elements implement this interface.
     * </p>
     *
    ...
    interface Entry<E> {
        ...
        /**
         * Compares the specified object with this entry for equality. Returns true if the given object is also a multiset entry and the two entries represent
     ...
     * <p>
     * If the object is already in the {@link #uniqueSet()} then increment its count as reported by {@link #getCount(Object)}. Otherwise, add it to the
    ...
    /**
     * Returns {@code true} if the MultiSet contains at least one occurrence for each element contained in the given collection.
     *
    ...
    /**
     * Returns an {@link Iterator} over the entire set of members, including copies due to cardinality. This iterator is fail-fast and will not tolerate
     ...
     * <p>
     * If the number of occurrences after this operation is reduced to zero, the object will be removed from the {@link #uniqueSet()}.
     * </p>
     *
     ...
     * <p>
     * If the provided count is zero, the object will be removed from the {@link #uniqueSet()}.
     * </p>
     *
