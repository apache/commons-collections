...
public class IterableUtils {
     ...
     * <p>
     * The returned iterable has an iterator that traverses the elements in the order of the arguments, i.e. iterables[0], iterables[1], .... The source
     ...
     * <p>
     * The returned iterable has an iterator that traverses the elements in {@code a}, followed by the elements in {@code b}. The source iterators are not
     ...
     * <p>
     * The returned iterable has an iterator that traverses the elements in {@code a}, followed by the elements in {@code b} and {@code c}. The source iterators
     ...
     * <p>
     * The returned iterable has an iterator that traverses the elements in {@code a}, followed by the elements in {@code b}, {@code c} and {@code d}. The
     ...
     *
     * @param <E>        The element type.
     * @param comparator The comparator defining an ordering over the elements, may be null, in which case natural ordering will be used.
     * @param a          The first iterable, may not be null.
     * @param b          The second iterable, may not be null.
    ...
    /**
     * Checks if the object is contained in the given iterable. Object equality is tested with an {@code equator} unlike {@link #contains(Iterable, Object)}
     * which uses {@link Object#equals(Object)}.
     * <p>
     * A {@code null} or empty iterable returns false. A {@code null} object will not be passed to the equator, instead a {@link NullPredicate NullPredicate}
     * will be used.
     * </p>
     *
     ...
     * <p>
     * The returned iterable's iterator supports {@code remove()} if {@code iterable.iterator()} does. After {@code remove()} is called, subsequent cycles omit
     * the removed element, which is no longer in {@code iterable}. The iterator's {@code hasNext()} method returns {@code true} until {@code iterable} is
     * empty.
     * </p>
     *
     * @param <E>      The element type.
     ...
     * <p>
     * For each predicate, the returned list will contain a collection holding all elements of the input iterable matching the predicate. The last collection
     ...
     * </pre>
     * <p>
     * <strong>Note</strong>: elements are only added to the output collection of the first matching predicate, determined by the order of arguments.
     * </p>
     * <p>
     * If the input iterable is {@code null}, the same is returned as for an empty iterable. If no predicates have been provided, all elements of the input
     * collection will be added to the rejected collection.
     * </p>
     * <p>
     * Example: for an input list [1, 2, 3, 4, 5] calling partition with predicates [x &lt; 3] and [x &lt; 5] will result in the following output: [[1, 2], [3,
     * 4], [5]].
     * </p>
     *
     ...
     */
    public static <O, R extends Collection<O>> List<R> partition(final Iterable<? extends O> iterable, final Factory<R> partitionFactory,
     ...
     * <p>
     * For each predicate, the result will contain a list holding all elements of the input iterable matching the predicate. The last list will hold all
     ...
     * <p>
     * In case the provided iterable is a {@link List} instance, a {@link ReverseListIterator} will be used to reverse the traversal order, otherwise an
     * intermediate {@link List} needs to be created.
     * </p>
     * <p>
     ...
     * Returns a string representation of the elements of the specified iterable.
     * <p>
     * The string representation consists of a list of the iterable's elements, enclosed by the provided {@code prefix} and {@code suffix}. Adjacent elements
     ...
     */
    public static <E> String toString(final Iterable<E> iterable, final Transformer<? super E, String> transformer, final String delimiter, final String prefix,
            final String suffix) {
     ...
     * <p>
     * The returned iterable's iterator supports {@code remove()} when the corresponding input iterator supports it. Calling {@code remove()} will only remove a
     * single element from the underlying iterator.
     * </p>
     *
     * @param <E>      The element type.
     * @param iterable The iterable to use, may not be null.
