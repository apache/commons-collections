 ...
 * storage. This MultiValuedMap implementation allows insertion order to be maintained.
 * <p>
 ...
 * collection may be specified. The default <code>LinkedList</code> will preserve
 * insertion order.
 * <p>
...
public class MultiValuedLinkedHashMap<K, V> extends AbstractMultiValuedMap<K, V> implements MultiValuedMap<K, V> {
    ...
    /**
     * Creates a MultiValuedLinkedLinkedHashMap copying all the mappings of the given map.
     *
