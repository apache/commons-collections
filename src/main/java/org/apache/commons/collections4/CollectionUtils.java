...
public class CollectionUtils {
     ...
     * @since 4.1
     * @deprecated use {@link IterableUtils#partition(Iterable, Predicate)} instead
     */
    @Deprecated
    public static <O> List<List<O>> partition(final Iterable<? extends O> inputCollection,
            final Predicate<? super O> predicate) {
        return IterableUtils.partition(inputCollection, predicate);
    }
     ...
     * @since 4.1
     * @deprecated use {@link IterableUtils#partition(Iterable, Predicate, Collection, Collection)} instead
     */
    @Deprecated
    public static <O, R extends Collection<? super O>> void partition(final Iterable<? extends O> inputCollection,
        ...
        IterableUtils.partition(inputCollection, predicate, outputCollection, rejectedCollection);
    }
    ...
    public static <O> List<List<O>> partition(final Iterable<? extends O> inputCollection,
        ...
        return IterableUtils.partition(inputCollection, predicates);
    }
     ...
     * @return a list containing the output collections
     * @since 4.1
     * @deprecated use {@link IterableUtils#partition(Iterable, Factory, Predicate...)} instead
     */
    @Deprecated
    public static <O, R extends Collection<O>> List<R> partition(final Iterable<? extends O> inputCollection,
        ...
        return IterableUtils.partition(inputCollection, partitionFactory, predicates);
    }
     ...
     * @throws IllegalArgumentException if the object type is invalid
     * @since 4.1
     * @deprecated use {@link EnumerationUtils#get(Enumeration, int)} instead
     */
    @Deprecated
    public static <T> T get(final Enumeration<T> e, final int index) {
        return EnumerationUtils.get(e, index);
    }
     ...
     * @since 4.1
     * @deprecated use {@link IterableUtils#retainAll(Iterable, Iterable, Equator)} instead
     */
    @Deprecated
    public static <E> Collection<E> retainAll(final Iterable<E> collection,
                                              final Iterable<? extends E> retain,
                                              final Equator<? super E> equator) {
        return IterableUtils.retainAll(collection, retain, equator);
    }
     ...
     * @throws NullPointerException if any of the parameters is null
     * @since 4.1
     * @deprecated use {@link IterableUtils#removeAll(Iterable, Iterable, Equator)} instead
     */
    @Deprecated
    public static <E> Collection<E> removeAll(final Iterable<E> collection,
                                              final Iterable<? extends E> remove,
                                              final Equator<? super E> equator) {
        return IterableUtils.removeAll(collection, remove, equator);
    }
